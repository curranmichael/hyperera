...
const PROMPT_OVERRIDES: Record<string, string> = {
  ...
  "messi-argentina-egypt-world-cup-quarters":
    "A vast floodlit football stadium at night seen from high in the stands, a brilliant green pitch far below ringed by tiers of blurred spectators, stadium lights blazing overhead, atmospheric and grand with no identifiable faces, themes of a dramatic World Cup victory. Absolutely no text, letters, words, numbers, scoreboards, jerseys with writing, sponsor boards, banners, logos or writing anywhere in the image",
  "manhattan-highrise-columns-buckle":
    "The soaring glass-and-steel facade of a half-renovated Manhattan skyscraper at dusk seen from the street below, scaffolding and dark empty windows on its upper floors, a cordon of barriers on the deserted pavement far below, tense and precarious with no people visible, themes of a great building's supports failing. Absolutely no text, letters, words, numbers, signs, billboards, logos, brand names or writing anywhere in the image",
  "getty-scraps-shutterstock-deal":
    "A vast dim archive hall lined with countless framed photographs and glowing light boxes receding into shadow, two dark computer screens at an empty workstation in the foreground, cool and still with no people visible, themes of two great picture libraries whose planned union has been called off. Absolutely no text, letters, words, numbers, captions, logos, brand names or writing anywhere on the photographs, screens or in the image",
  "illinois-ai-regulation-law":
    "A grand domed American state capitol building at dusk under a brooding stormy sky, in the foreground a single capped fountain pen resting beside a blank sheet of plain paper on a dark polished desk, solemn and momentous with no people visible, themes of lawmakers moving to rein in a powerful new technology. Absolutely no text, letters, words, numbers, handwriting, signs, logos or writing anywhere in the image",
  "hungary-halts-state-news-broadcasts":
    "A darkened television broadcast studio at night, an empty anchor desk and switched-off studio cameras under dim blue standby lighting, a single large blank grey monitor glowing pale on the back wall, deserted and silent, themes of a state news service gone dark. There are no images, no captions, no picture frames and nothing written on the monitor or anywhere. Absolutely no text, letters, words, numbers, headlines, logos, station idents or writing anywhere in the image",
  "russia-refinery-drone-halt":
    "A sprawling oil refinery at night with a plume of dark smoke and orange flame rising from a cluster of steel towers and pipework, floodlights glinting on the tangled machinery, a distant treeline against a deep blue sky, tense and ominous with no people visible, themes of an industrial plant struck and set ablaze. Absolutely no text, letters, words, numbers, signs, logos, brand names or writing anywhere in the image",
  "detroit-velazquez-attribution":
    "A hushed grand museum gallery at dusk, a single ornately gilded old-master portrait spotlit on a deep crimson wall, a polished wooden bench and herringbone parquet floor before it, reverent and quiet with no visitors, themes of a long-overlooked masterpiece revealed. The portrait's face is turned in soft shadow and indistinct. Absolutely no text, letters, words, numbers, labels, plaques, signatures, logos or writing anywhere in the image",
  "23andme-data-breach-payout":
    "A single luminous double-helix strand of DNA rendered in cold blue light floating against a deep dark background, faint fragments of broken padlock shapes dissolving into motes of light around it, shallow depth of field, clinical and unsettling with no people and no surfaces bearing writing, themes of intimate genetic secrets exposed. Absolutely no text, letters, words, numbers, code, symbols, labels, logos or writing anywhere in the image",
  "ioc-lifts-russia-suspension":
    "Five interlaced blank rings rendered in pale carved stone relief on a grand marble wall, a row of plain unmarked banners hanging still in an empty sunlit hall, solemn and formal with no people visible, themes of a barred nation welcomed back to the games. The rings and banners bear no emblems. Absolutely no text, letters, words, numbers, flags, emblems, logos or writing anywhere in the image",
  "exxon-q2-profit-windfall-oil":
    "A silhouetted cluster of oil pumpjacks and round storage tanks against a blazing deep-orange sunset, long shadows stretching across a flat industrial plain, a lone service road leading away, vast and still with no people visible, themes of great wealth pumped from the earth amid distant crisis. Absolutely no text, letters, words, numbers, signs, logos, brand names or writing anywhere in the image",
  "china-official-death-sentence-bribes":
    "A vast empty formal courtroom at dusk, a tall raised judicial bench in deep shadow beneath a dim round emblem, a single spotlit wooden lectern facing rows of empty seats, cold, austere and imposing with no people visible, themes of a powerful official condemned for corruption. Absolutely no text, letters, words, numbers, inscriptions, emblems with writing, signs, logos or writing anywhere in the image",
  "le-pen-2027-run-electronic-tag":
    "The pale stone facade and tall fluted columns of a grand French courthouse at dusk, wide empty steps rising to a shadowed portico, a set of brass scales of justice on a plinth to one side, austere and tense with no people visible, themes of a political leader convicted by the courts yet fighting to run for office. Absolutely no text, letters, words, numbers, inscriptions, engravings, signs, flags, logos or writing anywhere in the image",
  "farage-resigns-mp-clacton-byelection":
    "A plain wooden ballot box on a bare table beneath a single hanging lamp in a quiet British polling place at dusk, an empty voting booth with a drawn curtain to one side, plain undecorated walls, still and deserted with no people visible, themes of a politician resigning his seat to seek a fresh mandate from the people. Absolutely no text, letters, words, numbers, posters, notices, signs, logos or writing anywhere in the image",
  "trump-greenland-us-control-nato":
    "A stark Arctic coastline of dark wet rock and drifting pale sea ice under a vast cold overcast sky, a broad still fjord stretching to distant snow-streaked mountains, remote, vast and empty with no people visible, themes of a great power coveting a strategic Arctic island. Absolutely no text, letters, words, numbers, flags, signs, logos or writing anywhere in the image",
  "prince-harry-daily-mail-privacy-loss":
    "The tall fluted stone columns and broad steps of a grand London law court at dusk, a set of brass scales of justice resting on a plinth in the foreground, long cool shadows across the pavement, austere and hushed with no people visible, themes of a public figure's privacy claim weighed and dismissed by the court. Absolutely no text, letters, words, numbers, inscriptions, signs, newspapers, logos or writing anywhere in the image",
  "deepseek-develops-own-ai-chip":
    "A single mirror-bright silicon wafer held upright under cool clean-room light, its surface catching an intricate grid of microscopic circuitry in faint rainbow diffraction, deep shadow behind, precise, sleek and futuristic with no people visible, themes of a company forging its own dedicated engine of thought. Absolutely no text, letters, words, numbers, logos, brand names, labels or writing anywhere in the image",
  "data-centers-rust-belt-power-bills":
    "Rows of tall high-voltage electricity pylons and slack power lines marching across a bleak industrial plain toward a distant factory with cooling towers under a heavy grey sky, vast, orderly and cold with no people visible, themes of a hungry new industry driving up the cost of power for old factories. Absolutely no text, letters, words, numbers, signs, logos, brand names or writing anywhere in the image",
  "ukraine-shadow-fleet-tankers-azov":
    "A large oil tanker at sea at dusk with a column of dark smoke and orange flame rising from its deck, seen across calm open shallow water, a hazy distant coastline of low arid hills, a few small vessels on the horizon, tense and ominous with no people visible, themes of fuel ships struck and set ablaze at sea. Absolutely no text, letters, words, numbers, flags, hull markings, logos or writing anywhere in the image",
  "monaco-bombing-suspect-dead-ukraine":
    "A dim opulent marble apartment lobby at night, a single plain brown parcel resting alone on the polished floor beside a mirrored wall, cold light and long shadows, deserted and tense with no people visible, themes of a hidden device and a plot's loose end silenced. Absolutely no text, letters, words, numbers, labels, signs, logos or writing anywhere in the image",
  "cuba-islandwide-blackout-fuel":
    "A darkened Caribbean seaside city at night with almost all its lights out, faint silhouettes of low colonial buildings and a long sea wall against a deep blue starlit sky, a single dim glow in one distant window, still, powerless and hushed with no people visible, themes of a whole nation plunged into darkness as its fuel runs dry. Absolutely no text, letters, words, numbers, signs, shop fronts, logos or writing anywhere in the image",
  "amazon-25-billion-bond-ai":
    "A towering glass corporate skyscraper at dusk seen from below, its sheer facade reflecting a cool darkening sky, a scattering of faint gold light in its windows, sleek and imposing with no people visible, themes of vast sums borrowed to build for an uncertain future. Absolutely no text, letters, words, numbers, logos, brand names or writing anywhere in the image",
  "kere-tum-munich-vertical-kindergarten":
    "A striking top-heavy contemporary kindergarten building of warm timber wrapped in an angular facade of suspended weathered-steel slats, rising three storeys above a quiet tree-lined university street at golden hour, a small rooftop terrace of greenery, playful, warm and modern with almost no one about, themes of a joyful building made for children's play. Absolutely no text, letters, words, numbers, signs, logos, brand names or writing anywhere in the image",
  "damascus-explosions-macron-visit":
    "A thin column of grey smoke rising above the pale stone rooftops and slender minarets of an old Middle Eastern city at midday, a single black official state car on an empty palm-lined boulevard in the foreground, tense and hushed with no people visible, themes of a foreign dignitary's visit disrupted by a distant blast. Absolutely no text, letters, words, numbers, flags, license plates, signs, logos or writing anywhere in the image",
  "zelensky-nato-air-defence-appeal":
    "The shattered facade of a tall apartment block at dawn in a Northern European city, rows of blown-out dark windows and a plume of grey smoke rising into a pale sky, rubble and a lone bare tree in the foreground, deserted and still with no people visible, themes of a capital bombarded from the air and pleading for defence. Absolutely no text, letters, words, numbers, signs, flags, logos or writing anywhere in the image",
  "indonesia-india-brahmos-deal":
    "A single sleek supersonic cruise missile mounted on a green military transporter-launcher standing on an open coastal plain at golden hour, calm sea and pale sky behind, imposing and still with no people visible, themes of two nations sealing a weapons pact. Absolutely no text, letters, words, numbers, markings, insignia, flags, logos or writing anywhere on the vehicle or in the image",
  "trump-f35-jets-turkey":
    "A single sleek grey stealth fighter jet parked on an empty runway at dusk under a dramatic cloudy sky, low golden light glinting off its angular fuselage, distant hangars in silhouette, imposing and still with no people visible, themes of a coveted warplane offered to an ally. Absolutely no text, letters, words, numbers, tail markings, insignia, flags, roundels, logos or writing anywhere on the aircraft or in the image",
  "meta-states-1-4-trillion-youth-trial":
    "A young person's face softly lit from below by the pale glow of a smartphone held in the dark, wide absorbed eyes reflecting the screen, the room around them deep in shadow, themes of children, screens and addictive design under legal scrutiny. The screen is an indistinct blur of pale light. Absolutely no text, letters, words, numbers, app icons, logos or writing anywhere on the screen or in the image",
  "australia-teen-social-media-age-checks-fail":
    "A single smartphone held in a pair of young hands glowing with soft pale light against a dark background, a low unlatched garden gate standing open and unguarded in the soft-focus background, themes of a barrier meant to keep the young out that anyone can slip past. The screen is a blur of pale light. Absolutely no text, letters, words, numbers, app icons, logos, signs or writing anywhere in the image",
  "spacex-nasdaq-100-inclusion":
    "A single luminous line rising and arcing steeply toward its peak across a dark abstract field of soft blurred green and gold light, suggesting a soaring market chart at its zenith, minimal, sleek and elegant with no people visible, themes of a meteoric stock at a possible high. Absolutely no text, letters, words, numbers, tickers, symbols, logos or writing anywhere in the image",
  "proxima-fusion-google-rwe-funding":
    "A radiant twisting ring of blue-white plasma light suspended and glowing inside a dark futuristic circular chamber of coiled metal, like a small caged star, cool reflections on the machinery, awe-inspiring and clean with no people visible, themes of harnessing the power of the sun on Earth. Absolutely no text, letters, words, numbers, screens, symbols, logos or writing anywhere in the image",
  "china-hubei-tornado-deaths":
    "A vast dark funnel cloud of a tornado twisting down from a churning slate-grey storm sky over a distant low rural town, sheets of rain and a haze of swept-up debris around its base, bent trees in the foreground, terrifying and vast with no people visible, themes of a violent windstorm tearing across the land. Absolutely no text, letters, words, numbers, signs, logos or writing anywhere in the image",
  "south-korea-fake-news-law":
    "A single old cast-iron printing press standing dark, cold and motionless in an empty press hall at night, tall windows behind it and a single blank unprinted sheet in the carriage, bare plain walls with absolutely nothing hung on them, deep shadows, themes of a press silenced under threat of punishment. There are no newspapers, no posters, no picture frames, no boards, no notices and no printed sheets anywhere except the one blank sheet in the press. Absolutely no text, letters, words, numbers, headlines, columns of print, logos or writing anywhere in the image",
  "ram-temple-board-overhaul-donation-theft":
    "The dim ornate carved-stone sanctum of an Indian temple at dawn, a single large empty brass offering bowl resting on the polished floor beneath a pillared canopy, a soft shaft of golden light falling across it, hushed and solemn with no people visible, themes of sacred offerings betrayed and a holy trust broken. Absolutely no text, letters, words, numbers, inscriptions, symbols, logos or writing anywhere in the image",
  "bugatti-mistral-blanc-eternel":
    "A single pristine pure-white sculptural roadster hypercar displayed in a dark minimalist studio, its flowing sculpted body delicately traced all over with fine hand-painted cobalt-blue brush lines like porcelain decoration, soft directional spotlight and deep shadow, elegant and precious with no people visible, themes of fine porcelain craft married to a machine. Every surface is smooth and unbadged. Absolutely no text, letters, words, numbers, badges, number plates, logos, brand names or writing anywhere in the image",
  "casul-chair-childrens-play-set":
    "A single small pale birch-plywood child's chair partly unfolded into a simple abstract toy castle with cut-out battlements, standing on a plain seamless warm-grey studio floor in soft directional light, playful, clean and minimal with no people visible, themes of a humble object transforming for imaginative childhood play. Absolutely no text, letters, words, numbers, logos, brand names or writing anywhere in the image",
  ...
  "kyiv-drone-exhibition-strike-ten-killed":
    "The shattered facade of a large exhibition hall at dawn in a Northern European city, rows of blown-out dark windows and a tall plume of grey smoke rising into a pale sky, scattered rubble and a lone bare tree on the empty forecourt, deserted and still with no people visible, themes of a gathering struck from the air. Absolutely no text, letters, words, numbers, signs, flags, logos or writing anywhere in the image",
  "pakistan-tank-checkpoint-suicide-bombing":
    "A deserted fortified military checkpoint on a dusty road at dusk before arid hills, concrete blast barriers and stacked sandbags, a lowered barrier and a thin column of dark smoke rising against a deep orange sky, scorch marks across the empty road, tense and desolate with no people visible, themes of a frontier post struck by a devastating attack. Absolutely no text, letters, words, numbers, signs, flags, insignia, logos or writing anywhere in the image",
  "idaho-fast-food-shooting":
    "A deserted American shopping-center parking lot at night, a low fast-food restaurant with dark plain windows behind a scattering of orange traffic cones and plain smooth plastic barriers cordoning off the empty forecourt, cold blue-white light from a tall overhead lamp pooling on wet asphalt, still and desolate with no people visible, themes of sudden violence in an ordinary public place and a scene sealed off. There is no police tape and no banners anywhere; every surface, cone and wall is completely plain, smooth and blank. Absolutely no text, letters, words, numbers, signs, shop names, license plates, tape, ribbons, logos, brand names or writing of any kind anywhere in the image",
  "pakistan-suicide-bombing-northwest":
    "A deserted dusty town square at dusk in a northwestern frontier region before arid hills, overturned plastic chairs and a lone abandoned sandal scattered across the empty ground, a thin column of dark smoke rising against a deep orange sky and scorch marks on the earth, a low concrete building and blast barriers behind, tense and mournful with no people visible, themes of a peaceful gathering shattered by a devastating blast. Absolutely no text, letters, words, numbers, signs, flags, insignia, banners, logos or writing anywhere in the image",
};
